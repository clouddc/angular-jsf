...
<html>
    ...
    <body>
        ...
        <p>Note that while this page is not secured, both the WebSocket and
            REST endpoints are secured using HTTP BASIC authentication and SSL. You
            can set the usernames and SHA-256 encrypted passwords in the SQL load
            scripts of the application source.</p>
        <p>The WebSocket chat endpoint is at:
            <a href="wss://localhost:8181/javaee-mobile-server/chat">
                wss://localhost:8181/javaee-mobile-server/chat</a>. The
    ...
    <p>The REST endpoint is available at <a href="https://localhost:8181/javaee-mobile-server/resources/todo">
            http://localhost:8080/javaee-mobile-server/resources/todo</a>. The
        ...
        a GET request to this URL: <a href="https://localhost:8181/javaee-mobile-server/resources/todo/{username}">
            https://localhost:8181/javaee-mobile-server/resources/todo/{username}</a>.
    ...
    this URL: <a href="https://localhost:8181/javaee-mobile-server/resources/todo/{username}">
        https://localhost:8181/javaee-mobile-server/resources/todo/{username}</a>.
    ...
    request to this URL: <a href="https://localhost:8181/javaee-mobile-server/resources/todo/{username}/{id}">
        https://localhost:8181/javaee-mobile-server/resources/todo/{username}/{id}</a>.
    ...
    this URL: <a href="https://localhost:8181/javaee-mobile-server/resources/todo/{username}/{id}">
        https://localhost:8181/javaee-mobile-server/resources/todo/{username}/{id}</a>.
</p>
</body>
</html>
